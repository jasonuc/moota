...
func TestContainsPoint(t *testing.T) {
	t.Run("return true if point is the centre of circle", func(t *testing.T) {
		circle := CircleMeta{C: Coordinates{Lat: 10.0, Lon: 20.0}, R: 1000.0}
	...
	t.Run("return false if point is on the circumference of circle", func(t *testing.T) {
		circle := CircleMeta{C: Coordinates{Lat: 37.7749, Lon: -122.4194}, R: 1000.0}
...
func TestOverlapsWith(t *testing.T) {
	t.Run("return true for concentric circles", func(t *testing.T) {
		...
		circle1 := CircleMeta{C: center, R: 1000.0}
		circle2 := CircleMeta{C: center, R: 2000.0}
	...
	t.Run("return false for circles that do not overlap", func(t *testing.T) {
		circle1 := CircleMeta{C: Coordinates{Lat: 10.0, Lon: 20.0}, R: 1000.0}
		circle2 := CircleMeta{C: Coordinates{Lat: 10.025, Lon: 20.0}, R: 1000.0}
	...
	t.Run("return true for circles that overlap", func(t *testing.T) {
		circle1 := CircleMeta{C: Coordinates{Lat: 10.0, Lon: 20.0}, R: 1000.0}
		circle2 := CircleMeta{C: Coordinates{Lat: 10.012, Lon: 20.0}, R: 1000.0}
	...
	t.Run("return true for tangential circles", func(t *testing.T) {
		circle1 := CircleMeta{C: Coordinates{Lat: 37.7749, Lon: -122.4194}, R: 1000.0}
		circle2 := CircleMeta{C: Coordinates{Lat: 37.7749, Lon: -122.39125}, R: 1500.0}
