  ...
  return (
    <div className='flex flex-col space-y-5 grow'>
      ...
      <div className='flex flex-col space-y-5 w-full max-w-md mx-auto'>
        <img src={`https://api.dicebear.com/9.x/glass/svg`} alt='profile' className='w-full h-[15rem] object-cover rounded-md border-2 border-white' />
        ...
        <div className='flex justify-between items-center space-y-2'>
          <div className='flex flex-col items-center justify-between space-y-2'>
            <div className='relative flex items-center justify-center rounded-md size-12 border-2 border-white'>
              <img src='https://api.dicebear.com/9.x/glass/svg' alt='profile' className='absolute object-cover -z-10' />
              <h2>🌿</h2>
            </div>
            <p>{plantsAlive}</p>
          </div>
