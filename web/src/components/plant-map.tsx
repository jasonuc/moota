      ...
      <CardContent className="size-full relative p-0">
        <div className="absolute inset-0 bg-gradient-to-br from-green-100 to-blue-200">
            ...
            <>
              <svg className="absolute inset-0 w-full h-full">
                <line
                  ...
                  x2={`${Math.max(5, Math.min(95, (userX / mapWidth) * 100))}%`}
                  y2={`${Math.max(
                    5,
                ...
                style={{
                  ...
                  top: `${
                    (Math.max(5, Math.min(95, (plantY / mapHeight) * 100)) +
                      Math.max(5, Math.min(95, (userY / mapHeight) * 100))) /
                      2 -
                    5
                  }%`,
          ...
          <div
            className="absolute transform -translate-x-1/2 -translate-y-full z-10"
            style={{
              left: `${Math.max(5, Math.min(95, (plantX / mapWidth) * 100))}%`,
              top: `${Math.max(5, Math.min(95, (plantY / mapHeight) * 100))}%`,
            }}
          >
            <Flower2Icon className="text-green-500 drop-shadow-lg" size={24} />
          </div>
