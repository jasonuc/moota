...
export default function Plant({
  ...
  hp,
  distanceM,
}: UnactivatedPlantProps) {
  const navigate = useNavigate();

  const handleActivatePlant = async () => {
    activatePlant(id).then((plant) => {
